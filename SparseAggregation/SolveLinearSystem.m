...
if nargin < 8
    ...
    if isSymmetric==0
        params{alg}.TopAcceleration = 'NONE';
        params{alg}.P_smoothing_omega_val = (5/4);
    else
        params{alg}.TopAcceleration = 'NONE'; % changed from 'PCG' to 'GMRES' on 1/16
        params{alg}.P_smoothing_omega_val = 4/3;
    end
    disp(params{alg}.TopAcceleration)
    ...
    params{alg}.setup_method = method; % see SetupVcycleT.m
    ...
    params{alg}.nu1 = 1; % pre relaxations V(1,1)
