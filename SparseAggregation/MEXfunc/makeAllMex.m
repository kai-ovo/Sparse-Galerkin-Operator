...
mex -largeArrayDims MulticolorGaussSeidelSMatTranspose.c LDFLAGS="\$LDFLAGS -fopenmp" % COMPFLAGS="$COMPFLAGS -openmp" LINKFALGS="$LINKFALGS -openmp"

mex -largeArrayDims JacobiSMatTranspose.c LDFLAGS="\$LDFLAGS -fopenmp" %COMPFLAGS="$COMPFLAGS -openmp" LINKFALGS="$LINKFALGS -openmp"
...
mex -O 'CXXOPTIMFLAGS=-DNDEBUG -O3' -largeArrayDims SparsifyCollapsedGalerkinMex_new.c LDFLAGS="\$LDFLAGS -fopenmp" %COMPFLAGS="$COMPFLAGS -openmp" LINKFALGS="$LINKFALGS -openmp";

mex  -O 'CXXOPTIMFLAGS=-DNDEBUG -O3' -largeArrayDims SparsifyCollapsingMex.c LDFLAGS="\$LDFLAGS -fopenmp"%COMPFLAGS="$COMPFLAGS -openmp" LINKFALGS="$LINKFALGS -openmp"
